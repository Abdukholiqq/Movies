...
.then(data => {
  ...
  function  renderObj(films){
    ...
    films.forEach(element => {
        ...
        card.innerHTML = `
      <img class="" src="${element.Poster}" alt="img" style="height: 550px;  ">
      <h3 class= "text-center mt-4 mb-2 text-info">  ${element.Title}</h3>
            <h4 class="text-center mb-2 text-info" > ${element.Type}  ${element.Year}</h4>
 `
